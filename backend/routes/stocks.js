...
router.get('/stock-timeseries/:interval:from/:to/:stock', stocksController.stocks.finnhub.stocks.timeSeries);
...
// Stock Symbol SEARCH
router.get('/stock-search/:symbol', stocksController.stocks.finnhub.stocks.search);
